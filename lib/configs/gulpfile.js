...
_gulp2.default.task('scripts', function () {
  return _gulp2.default.src(['src/**/*.js'])
  // babel es5
  .pipe((0, _gulpBabel2.default)(babelrc))
  // 替换 js 文件中引用的 .scss 后缀为 .css
  .pipe((0, _gulpReplace2.default)(/require\((['"])(.+?)(\.scss)['"]\)/g, 'require($1$2.css$1)'))
  // 替换 tsx? 为 js
  .pipe((0, _gulpReplace2.default)(/require\((['"])(.+?)(\.tsx?)['"]\)/g, 'require($1$2.js$1)')).pipe(_gulp2.default.dest('lib'));
});

// es6代码转义es5
_gulp2.default.task('typescript', _asyncToGenerator(function* () {
  return _gulp2.default.src(['src/**/*.ts', 'src/**/*.tsx'])
  // 解析 typescript 语法
  .pipe(tsProject())
  // babel es5
  .pipe((0, _gulpBabel2.default)(babelrc))
...
_gulp2.default.task('style', function () {
  return _gulp2.default.src(['./src/**/*.scss', './src/**/*.css']).pipe(_gulpSass2.default.sync().on('error', _gulpSass2.default.logError))
  // 缩进2个空格
  .pipe((0, _gulpCssbeautify2.default)({ indent: '  ' })).pipe(_gulp2.default.dest('lib'));
});
