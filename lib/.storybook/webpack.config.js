...
var _webpackMonitor = require('webpack-monitor');

var _webpackMonitor2 = _interopRequireDefault(_webpackMonitor);
...
exports.default = (storybookBaseConfig, configType) => {
  ...
  storybookBaseConfig.resolve.alias = {
    ...
    // 组件依赖分析
  };storybookBaseConfig.plugins.push(new _webpackMonitor2.default({
