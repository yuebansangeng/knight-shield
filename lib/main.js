...
const main = (() => {
  var _ref = _asyncToGenerator(function* () {
    ...
    const status = yield (0, _makeStories2.default)({ storybookConfigPath });

    let cp = (0, _child_process.spawn)('npx', ['start-storybook', '-s', '.', '-p', port, '-c', _path2.default.join(storybookConfigPath)],
    // tsconfig.json 的配置以及
