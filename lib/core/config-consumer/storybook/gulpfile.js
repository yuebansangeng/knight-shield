...
_gulp2.default.task('typescript', function () {
...
_gulp2.default.task('style', function () {
  return _gulp2.default.src(['./src/**/*.scss', './src/**/*.css']).pipe(_gulpSass2.default.sync()).pipe((0, _gulpCssbeautify2.default)({ indent: '  ' })).pipe(_gulp2.default.dest('lib'));
});
