...
exports.default = class extends _yeomanGenerator2.default {
  ...
  writing() {
    ...
    return _asyncToGenerator(function* () {
      let { contextRoot, independent, rc, onlyUpdated, output = contextRoot } = _this.options;
      ...
      if (independent) {
        ...
        for (let i = 0; i < components.length; i++) {
          ...
          yield (0, _buildCmpStatics2.default)({ 'contextRoot': components[i], output, onlyUpdated });
        }
      } else {
        ...
        yield (0, _buildCmpStatics2.default)({ contextRoot, components, onlyUpdated });
      }
