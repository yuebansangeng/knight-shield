...
exports.default = (() => {
  var _ref = _asyncToGenerator(function* (o) {
    ...
    return yield (0, _execa2.default)('node', ['node_modules/.bin/gulp', '--gulpfile', _path2.default.join(__dirname, '..', '..', '..', 'configs', 'gulpfile.js'), '--cwd', contextRoot, '--colors'], { 'encoding': 'utf8' });
  });
